...
namespace DevSteamAPI.Controllers
{
    ...
    public class CarrinhosController : ControllerBase
    {
        ...
        // GET: api/Carrinhos/DataCriacao/{dataCriacao}
        [HttpGet("DataCriacao/{dataCriacao}")]
        public async Task<ActionResult<IEnumerable<Carrinho>>> GetCarrinhosByDataCriacao(DateTime dataCriacao)
        {
            var carrinhos = await _context.Carrinho
                .Where(c => c.DataCriacao.HasValue && c.DataCriacao.Value.Date == dataCriacao.Date)
                .ToListAsync();
